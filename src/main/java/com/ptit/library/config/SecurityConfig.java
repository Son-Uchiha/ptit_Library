...
import com.ptit.library.security.JwtAuthenticationEntryPoint;
import com.ptit.library.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/css/**", "/js/**", "/images/**", "/image/**", "/data/**").permitAll()
